...
public class HDBOfficerMenu {
    public static void hdbOfficerMenu(User user) {
        ...
        while (true) {  // Main menu loop
            ...
            switch (choice) {
                ...
                //                 && project != user.getAssignedProject()
                //                 && project != user.getApplication().getProject()) {
                ...
                //         System.out.printf("%d. Message: %s\n", i + 1, listNoReplyEnquiries.get(i).getMessage());
                //     }
                ...
                //     listNoReplyEnquiries.get(enquiryChoice - 1).reply(response);
